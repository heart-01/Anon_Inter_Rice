...
<div class="container">
    ...
    <div class="col-md-12 d-flex justify-content-end" style="margin-top: 20px;">
      ...
      <input type="text" class="form-control col-3" maxlength="50" placeholder="ค้นหาทะเบียนรถ" id="txtSearch" name="txtSearch">
    </div>
    ...
    <?php
      ...
      $sql_count="SELECT * FROM vehicle WHERE vehicleNo!=1";
      ...
      $sql = "SELECT * FROM vehicle WHERE vehicleNo!=1 LIMIT 10 OFFSET $pf";
    ...
    <?php
	    ...
	    for($p=1;$p<=$page;$p++)
	    {
		    echo "<a href='vehicle?pf=$first_post&pl=$last_post&index=$p' class='Lpage'>" . $p . "</a>";  if($p!=$page){echo " , ";}
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header bg-primary text-white">
        <h5 class="modal-title" id="exampleModalLabel"><i class="fas fa-truck-moving"></i> เพิ่มข้อมูลทะเบียนรถ</h5>
      ...
      <div class="modal-body">
        <form id="frAddMill">
          <div class="form-group">
            ...
            <input class="form-control" name="vehicle" id="message-text" maxlength="50" required></input>
          </div>
      </div>
            ...
            $.ajax({
              ...
              success: function(data){
                ...
                if(data==""){
                  ...
                  alert('มีชื่อทะเบียนรถนี้อยู่แล้ว');
                  $('#error').modal('show');
                  $("#btnCon").attr('disabled', false); 
                }
			        }, // ปิด .success
