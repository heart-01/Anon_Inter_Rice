  ...
  <div class="modal-dialog modal-sm">
    ...
    <script>
        ...
        $("#locat").change(function(){
            ...
            var dateBalance = $("#dateBalance").val();
            var url = "../api/balanceSearch.php";
            var data_set = {location : location, dateBalance : dateBalance};
        ...
        $("#btnCon").click(function(){
            ...
            if(staEli==0&&staBal==0){
                ...
                if(add==""){
                    ...
                    var data_set = {add : add, location : location,dateBalance : dateBalance};
                    $.post(url,data_set,function(data){
                        if(data=="Not Query"){
                ...
                if(edit==""){
                    ...
                    var data_set = {edit : edit, location : location, dateBalance : dateBalance};
                    $.post(url,data_set,function(data){
                        if(data=="Not Query"){
