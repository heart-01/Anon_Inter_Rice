...
?>
<title>ข้อมูลลานตัก</title>
<body>    
<!-- CSS -->
<link href="../css/lap.css" rel="stylesheet"> 
...
<div class="container">
    ...
    <div class="col-md-12 d-flex justify-content-end" style="margin-top: 20px;">
      ...
      <input type="text" class="form-control col-3" maxlength="50" placeholder="ค้นหาลานตัก" id="txtSearch" name="txtSearch">
    </div>

    <div class="row lapDetail">

    <?php
      require_once '../api/connect.php';
      $sql_count="SELECT * FROM location WHERE locationNo!=1";
      ...
      $sql = "SELECT * FROM location WHERE locationNo!=1 LIMIT 10 OFFSET $pf";
    ...
    <div class="col-md-12 d-flex justify-content-end" style="margin-top: 20px;margin-bottom: 20px">
        <a href="#" class="btn btn-primary btn-sm pull-right" id="btnAddData" data-toggle="modal" data-target="#addData"><b><i class="fas fa-plus-circle"></i></b> เพิ่มข้อมูลลานตัก</a>
    </div>
        <tr>
            <th>รหัส</th>
            <th>ชื่อลานตัก</th>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="text-center">
              <a class='btn btn-warning text-white btn-sm editData' data-toggle="modal" data-target="#editData" id="<?php echo $data["locationNo"]; ?>" href=""><i class="far fa-edit"></i> แก้ไข</a> 
              <a href="#" class="btn btn-danger btn-sm delData" data-toggle="modal" data-target="#delData" id="<?php echo $data["locationNo"]; ?>"><i class="fas fa-trash-alt"></i> ลบ</a>
            </td>
        </tr>
        <?php
            }
    ...
    <?php
	    ...
	    for($p=1;$p<=$page;$p++)
	    {
		    echo "<a href='detailLap?pf=$first_post&pl=$last_post&index=$p' class='Lpage'>" . $p . "</a>";  if($p!=$page){echo " , ";}
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header bg-primary text-white">
        <h5 class="modal-title" id="exampleModalLabel"><i class="fas fa-campground"></i> เพิ่มข้อมูลลานตัก</h5>
      ...
      <div class="modal-body">
        <form id="frAdd">
          <div class="form-group">
            ...
            <input class="form-control" name="location" id="message-text" maxlength="50" required></input>
          </div>
      </div>
  ...
  <div class="modal-dialog modal-sm">
    ...
    <script>
        ...
        $(".delData").click(function(){
          ...
          var url = "../api/lapDelShow.php";
		      var data_set = { delData : locationNo };
       ...
       $(".editData").click(function(){
          var locationNo = $(this).attr('id');
          var url = "../api/lapEditShow.php";
			    var data_set = { editData : locationNo };
          $.post(url,data_set,function(data){
            $("#showEdit").html(data);
            $('#editData').modal('show');
            //console.log(data);
